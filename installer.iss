...
; File Processor
Source: "release-build\finalCompressed\fileprocessor\*"; DestDir: "{app}\fileprocessor"; Flags: ignoreversion recursesubdirs; Excludes: "*.pdb *.log"
; IPFS
Source: "release-build\ipfsnode\*"; DestDir: "{app}\ipfsnode"; Flags: ignoreversion
; Supervisor processor
Source: "release-build\finalCompressed\publish\*"; DestDir: "{app}"; Flags: ignoreversion
